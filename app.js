...
function buildHomeCharacterGuide(category, tier, share){
  ...
  const profiles = {
    "食費":"毎日の満足度を土台から整えるキャラクターです。おいしさや安心感にきちんと価値を感じられるタイプで、無理に削るより、満たされる使い方を選べると強くなります。",
    "外食費":"気分転換や特別感を楽しむのが上手なキャラクターです。誰とどこで過ごすかも含めて支出の意味を感じやすく、体験の質が高いほど魅力が伸びます。",
    "日用品":"暮らしの細部を整えて安定感をつくるキャラクターです。派手さより使いやすさや快適さを大事にしていて、生活の基盤を静かに支える力があります。",
    "衣服":"見た目と気分のスイッチを上手に切り替えるキャラクターです。自分らしさを表現する感度が高く、納得できる一着を選べるほど洗練されていきます。",
    "美容":"自分のコンディションを丁寧に整えるキャラクターです。見た目だけではなく、気分や自信の回復にも価値を感じやすく、継続的な手入れと相性がいいタイプです。",
    "交際費":"人とのつながりを育てることが得意なキャラクターです。会う時間や場の空気に価値を見いだしやすく、相手との関係が深まる使い方で力を発揮します。",
    "プレゼント":"喜ばせること自体に満足を感じるキャラクターです。相手を思って選ぶ時間まで含めて価値にできるので、気持ちが乗った支出ほどこのキャラクターらしさが出ます。",
    "医療費":"安心を先回りして守るキャラクターです。目立たなくても必要なところにきちんとお金を回せるタイプで、体調管理や備えの丁寧さが強みです。",
    "教育費":"未来に向けて力を積み上げるキャラクターです。今より先の成長を信じて投資できるタイプで、学びが実感につながるほど頼もしく育ちます。",
    "交通費":"移動の効率と快適さを支えるキャラクターです。行動力を止めないための支出に意味を見いだしやすく、時間の使い方が上手になるほど安定します。",
    "コンビニ":"即判断で暮らしを回すスピード型キャラクターです。必要なときにすぐ補給できる反面、流れで使いやすいので、選び方が整うと一気に賢くなります。",
    "カフェ":"休息と集中のリズムを整えるキャラクターです。一杯の時間で気持ちを切り替えるのが上手で、自分に合う使い方が見つかるほど心地よさが増します。",
    "デート":"思い出や一緒に過ごす時間を大切にするキャラクターです。体験の濃さに価値を感じやすく、背伸びよりも満足度の高い過ごし方で魅力が伸びます。",
    "趣味":"好きにまっすぐ熱量を注げるキャラクターです。楽しいことへの集中力が高く、満足できる使い方ができると、このキャラクターらしい強さがはっきり出ます。",
    "仕事":"成果の出る環境づくりにお金を使えるキャラクターです。効率や進めやすさを重視する現実派で、仕事の手応えにつながる支出ほど相性がいいです。",
  };
  const stateMap = {
  ...
  return {
    ...
    profile: `${profiles[category] || "特定の価値を大事にしてお金を使うキャラクターです。"}納得できる使い方が増えるほど、同じカテゴリでもより安定した上位キャラクターに育っていきます。`
  };
}
