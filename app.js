...
function closeModal(id){
  ...
  if(id === "resultModal"){
    el.classList.remove("is-story-mode");
  }
...
function buildHomeCharacterGuide(category, tier, share){
  ...
  const profiles = {
    "食費": {
      great:"食卓の満足度をちゃんと育てられるキャラクターです。毎日の食事に安心感と幸福感をつくるのが上手で、量より満たされ方を選べています。",
      good:"食事から元気を補給するのが上手なキャラクターです。おいしさと日常の安定を大事にしていて、使い方にも素直さがあります。",
      bad:"食べることが好きで満足感を求めやすいキャラクターです。気分で選びやすいぶん、少し整えるだけでぐっと良くなります。",
      verybad:"食の勢いが強く出ているキャラクターです。満たされたい気持ちは大きい一方で、選び方が荒れると暴走しやすいタイプです。"
    },
    "外食費": {
      great:"外食を体験価値として上手に楽しめるキャラクターです。誰とどこで過ごすかまで含めて満足度につなげられています。",
      good:"外で食べる時間にちゃんと意味を見つけられるキャラクターです。気分転換やご褒美の使い方が比較的うまいタイプです。",
      bad:"楽しい外食に引っ張られやすいキャラクターです。場の空気には強いけれど、なんとなくの利用が増えるとブレが出ます。",
      verybad:"外食の誘惑に飲まれやすいキャラクターです。特別感を求める力が強く、勢いに乗ると支出も膨らみやすいタイプです。"
    },
    "日用品": {
      great:"暮らしを整える力が高いキャラクターです。必要なものを見極めて、生活の快適さを静かに底上げできます。",
      good:"生活基盤をきちんと保つことが得意なキャラクターです。使いやすさや安心感への感度が高く、堅実さがあります。",
      bad:"整えたい気持ちは強いけれど、ついで買いに流れやすいキャラクターです。判断の軸が戻ると一気に安定します。",
      verybad:"備えや便利さを求める気持ちが膨らみやすいキャラクターです。必要以上に抱え込みやすく、暮らしを整えるつもりが逆に重くなりがちです。"
    },
    "衣服": {
      great:"自分らしさを上手に表現できるキャラクターです。見た目と気分のバランスがよく、納得できる一着を選ぶ感覚が育っています。",
      good:"装いで気分を整えるのが上手なキャラクターです。見栄ではなく、自分に似合うものへ素直にお金を使えています。",
      bad:"新しさや変化に心が動きやすいキャラクターです。似合うものを選ぶ力はあるので、勢い買いが減るほど魅力が増します。",
      verybad:"服で気分を一気に変えたくなるキャラクターです。自己表現の熱量が高いぶん、判断が荒れると散らかりやすいタイプです。"
    },
    "美容": {
      great:"自分を整えることに丁寧なキャラクターです。見た目だけでなく気分や自信まで含めて、良い循環をつくれています。",
      good:"コンディション維持が上手なキャラクターです。無理なく続けられる範囲で、きちんと自分に投資できています。",
      bad:"きれいでいたい気持ちが強いキャラクターです。期待に引っ張られやすいので、効くものを絞ると安定します。",
      verybad:"不安や焦りから美容に頼りやすいキャラクターです。変わりたい気持ちは強いけれど、勢いで選ぶと空回りしやすいタイプです。"
    },
    "交際費": {
      great:"人との関係を心地よく育てられるキャラクターです。相手との時間に意味を持たせるのが上手で、使い方にも温かさがあります。",
      good:"つながりを大切にできるキャラクターです。誰かと過ごすことに価値を感じつつ、自分のペースも保てています。",
    ...
    "医療費": {
      ...
      good:"備えとケアの感覚があるキャラクターです。派手ではなくても、必要なところへきちんとお金を回せる堅実さがあります。",
      bad:"不調への不安が少し強く出やすいキャラクターです。守りたい気持ちは大事なので、必要な線引きができると落ち着きます。",
      verybad:"不安に押されて備えすぎやすいキャラクターです。安心を求める気持ちは強いけれど、気持ちが先走ると重たくなりやすいタイプです。"
    },
    "教育費": {
      great:"未来に向けた投資が上手なキャラクターです。学びや成長を一過性で終わらせず、着実な力に変える感覚があります。",
      good:"成長への期待を持てるキャラクターです。今より先を良くするためにお金を使う意識があり、前向きな投資ができています。",
      bad:"学びたい気持ちが先行しやすいキャラクターです。伸びたい意欲は強いので、優先順位を絞ると一気に良くなります。",
      verybad:"将来不安から学びに頼りすぎやすいキャラクターです。前向きさはあるものの、詰め込みすぎると成果より負担が先に来やすいタイプです。"
    },
    "交通費": {
      great:"移動をストレスなく整えるのが上手なキャラクターです。時間と体力を守るための使い方ができていて、行動の質が高いです。",
      good:"動きやすさを大事にできるキャラクターです。効率と快適さを程よく選べるので、毎日の回り方が安定しています。",
      bad:"面倒を避けたい気持ちが少し出やすいキャラクターです。楽さを求める感覚は自然なので、使いどころを選べると整います。",
      verybad:"移動の負担をお金で一気に解決したくなるキャラクターです。疲れたときほど使い方が荒れやすく、積み重なると大きくなりやすいタイプです。"
    },
    "コンビニ": {
      great:"必要なときに必要なだけ使えるキャラクターです。即決型でも散らからず、スピード感と納得感を両立できています。",
      good:"暮らしを手早く回すのが上手なキャラクターです。小さな支出をうまく使って、日常を補助する感覚があります。",
      bad:"流れのまま買いやすいキャラクターです。便利さへの反応が早いぶん、ひと呼吸おけるとかなり賢くなります。",
      verybad:"その場の気分で手が伸びやすいキャラクターです。即時満足に強く引っ張られるので、積み重なると見えにくく膨らみやすいタイプです。"
    },
    "カフェ": {
      great:"休息と集中の切り替えが上手なキャラクターです。一杯の時間を気分の回復や思考整理につなげられています。",
      good:"心地よい余白をつくれるキャラクターです。カフェ時間を無駄にせず、自分のペースを整える使い方ができています。",
      bad:"気分転換を求めて立ち寄りやすいキャラクターです。空間に癒やされる感覚は強いので、回数が整うとちょうどよくなります。",
      verybad:"疲れや逃避でカフェに流れ込みやすいキャラクターです。休みたい気持ちは本物ですが、習慣化すると支出の輪郭がぼやけやすいタイプです。"
    },
    "デート": {
      great:"思い出の質を大切にできるキャラクターです。相手との時間にしっかり価値を感じつつ、背伸びしすぎない使い方ができています。",
      good:"一緒に過ごす体験を楽しめるキャラクターです。気持ちと支出のバランスが比較的よく、満足度の高い時間を作れています。",
      bad:"特別にしたい気持ちが強めのキャラクターです。ロマンや雰囲気を大事にするぶん、見栄が混ざるとブレが出やすいです。",
      verybad:"印象よく見せたい気持ちが強く出ているキャラクターです。思い出を大事にする反面、背伸びが続くと負担になりやすいタイプです。"
    },
    "趣味": {
      great:"好きなことに深く満足してお金を使えるキャラクターです。熱量を楽しさへ変えるのが上手で、支出も納得感につながっています。",
      good:"楽しさに素直なキャラクターです。趣味の時間がちゃんと回復や充実につながっていて、気持ちの使い方がうまいです。",
      bad:"ハマると一直線になりやすいキャラクターです。好きの力は大きいので、熱量の置き場所を選べるとかなり強いです。",
      verybad:"好きなものへの加速が止まりにくいキャラクターです。没頭できる魅力はある一方で、課金や収集が膨らみやすいタイプです。"
    },
    "仕事": {
      great:"成果につながる使い方ができるキャラクターです。必要な道具や環境を見極めて、仕事の質を上げる方向へお金を回せています。",
      good:"実務感覚のあるキャラクターです。効率や進めやすさを大事にしながら、比較的ムダの少ない投資ができています。",
      bad:"焦りから仕事関連の支出に寄りやすいキャラクターです。前に進みたい意欲は強いので、目的が明確になるほど安定します。",
      verybad:"不安を埋めるために仕事道具へ頼りやすいキャラクターです。頑張りたい気持ちは大きいですが、買うことで解決しようとすると膨らみやすいタイプです。"
    }
  };
  const stateMap = {
  ...
  return {
    ...
    profile: `${profiles[category]?.[tierKey] || "特定の価値を大事にしてお金を使うキャラクターです。"}納得できる使い方が増えるほど、同じカテゴリでもより安定した上位キャラクターに育っていきます。`
  };
}
...
function setResultModalMode(mode = ""){
  const modal = $("resultModal");
  if(!modal) return;
  modal.classList.toggle("is-story-mode", mode === "story");
}
...
function showMonthlyScore(){
  ...
  if(view) view.innerHTML = result.html;
  if(txt) txt.textContent = result.text;
  setResultModalMode(result.mode || "");
  if(view) animateDonuts(view);
  bindScatterTooltips();
          ...
          <div class="monthlyWrapViewport monthlyStoryViewport">
            <div class="monthlyWrapTrack monthlyStoryTrack">
              <section class="monthlyWrapCard monthlyStoryPage is-hero">
                <div class="monthlyStoryAura"></div>
              ...
              <section class="monthlyWrapCard monthlyStoryPage is-top">
              ...
              <section class="monthlyWrapCard monthlyStoryPage is-risk">
              ...
              <section class="monthlyWrapCard monthlyStoryPage is-action">
                <div class="monthlyStoryBadge">来月のひとこと</div>
...
変動費：${varSpend}円
`;
  return { html, text, missingSaving:false, mode:"story" };
}
